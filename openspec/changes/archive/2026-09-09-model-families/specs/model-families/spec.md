...
Exactly one of a task's families SHALL be selected at any time. The selected family SHALL
decide which knobs the workshop presents and which model the workshop is making. WHEN
progress states nothing about which family is selected, the task's first declared family
SHALL be selected, rather than none.
...
- **THEN** its first declared family is selected
