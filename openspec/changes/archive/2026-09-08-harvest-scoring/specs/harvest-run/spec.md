...
the size the farm declares and growing as the orchard does, so that the crop harvested is
the crop the farm actually bears. A farm recording no usable size SHALL refuse to draw a
crop, naming the size it found.
